<div class="inline-flex items-center ml-5 space-x-6 lg:justify-end">
    <div x-data="{ fullscreenModal: false }" x-init="$watch('fullscreenModal', function(value) {
        ...
        <a @click="fullscreenModal=true"
            class="relative inline-block text-lg group text-base font-medium leading-6 text-gray-600 whitespace-no-wrap transition duration-150 ease-in-out hover:text-gray-900">
            Sign in
        </a>
                    ...
                    <div class="relative w-full max-w-sm mx-auto lg:mb-0">
                        ...
                        <div class="relative text-center">
                            ...
                            <div class="flex flex-col mb-6 space-y-2">
                                <h1 class="text-2xl font-semibold tracking-tight">Login ke akun mu
                                </h1>
                                <p class="text-sm text-neutral-500">Masukkan email dan password anda untuk login
                                    ke akunmu</p>
                            </div>
                            <form method="POST" action="{{route('login.seller')}}" class="space-y-2">
                                @csrf
                                <input id="merchantName" type="text" placeholder="name@example.com" name="email"
                        ...
                        <p class="mt-6 text-sm text-center text-neutral-500">Belum punya akun? <a href="#_"
                                class="relative font-medium text-blue-600 group"><span>Masuk</span><span
